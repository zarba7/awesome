...
func NewRedisClient(addr, auth string, db int) *RedisCli {	return &RedisCli{redisCli(addr,auth,db)}}

type RedisCli struct {
	*redis.Client
}

func (the *RedisCli) Pipeline(fun func(pipe redis.Pipeliner)) ([]redis.Cmder, error) {
